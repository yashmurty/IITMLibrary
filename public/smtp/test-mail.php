...
require 'PHPMailer/PHPMailerAutoload.php';
	 ...
	 $mail->From = "msoffice@iitm.ac.in"; // "name@yourdomain.com";
	 $mail->FromName = "DoMS, IIT Madras";  // set from Name
	 $mail->Subject ="Referee comments for IIT Madras MBA Program";
	 $mail->Body = "Dear "."name".",<br><br>
	        You have been nominated as a referee to give
	        your assessment of the applicant's ability and
	        suitability for the MBA program at IIT Madras.<br>
